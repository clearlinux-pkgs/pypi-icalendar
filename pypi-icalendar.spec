...
Source0  : https://files.pythonhosted.org/packages/c0/04/0ca754a6da85c09e0edc704e38a661995c493c6a019e51c7465911431fb8/icalendar-6.1.2.tar.gz
...
%prep
%setup -q -n icalendar-6.1.2
cd %{_builddir}/icalendar-6.1.2
pushd ..
cp -a icalendar-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742394025
