...
Source0  : https://files.pythonhosted.org/packages/03/44/c9fdf8f6442e5bef2635f25dbb3d3ac12d5f2ecf5223bd94acaba51ceda4/icalendar-6.1.0.tar.gz
...
%prep
%setup -q -n icalendar-6.1.0
cd %{_builddir}/icalendar-6.1.0
pushd ..
cp -a icalendar-6.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732471647
