...
Source0  : https://files.pythonhosted.org/packages/fd/b3/8fcd017f8fbaf5c3b8cd1e21dcc3f12158ce08c577b426c3c8eb21373656/icalendar-6.1.1.tar.gz
...
%prep
%setup -q -n icalendar-6.1.1
cd %{_builddir}/icalendar-6.1.1
pushd ..
cp -a icalendar-6.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737389430
