...
Source0  : https://files.pythonhosted.org/packages/3c/d8/ada43e4872aab3bfaf2cc2e09b2d2a5d83f771bfc58ba6a63904a5067db8/icalendar-5.0.13.tar.gz
...
%prep
%setup -q -n icalendar-5.0.13
cd %{_builddir}/icalendar-5.0.13
pushd ..
cp -a icalendar-5.0.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718920048
