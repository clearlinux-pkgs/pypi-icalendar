...
Source0  : https://files.pythonhosted.org/packages/4f/3b/6532b45eef165c32fad5db2ce9b2a5669a4faeff232ab0bf0be2c576e9f5/icalendar-6.1.3.tar.gz
...
%prep
%setup -q -n icalendar-6.1.3
cd %{_builddir}/icalendar-6.1.3
pushd ..
cp -a icalendar-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743170803
