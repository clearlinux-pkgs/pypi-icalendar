...
Version  : 6.2.0
Release  : 85
URL      : https://files.pythonhosted.org/packages/42/86/dd453fb8eb03288ea06b0980b08614609e7e7ad87245be5e8d4ea3b3bc14/icalendar-6.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/42/86/dd453fb8eb03288ea06b0980b08614609e7e7ad87245be5e8d4ea3b3bc14/icalendar-6.2.0.tar.gz
...
%prep
%setup -q -n icalendar-6.2.0
cd %{_builddir}/icalendar-6.2.0
pushd ..
cp -a icalendar-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746641686
